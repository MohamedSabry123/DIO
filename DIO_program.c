...
u8 DIO_u8GetPortValue    (u8 Copy_u8PortId , u8 *Copy_Pu8ReturnedPortValue)
{
	...
	if(Copy_Pu8ReturnedPortValue != NULL)
	{
		switch(Copy_u8PortId)
		{
			case DIO_u8_PORTA : *Copy_Pu8ReturnedPortValue = DIO_u8_PORTA_REG ; break ;
			case DIO_u8_PORTB : *Copy_Pu8ReturnedPortValue = DIO_u8_PORTB_REG ; break ;
			case DIO_u8_PORTC : *Copy_Pu8ReturnedPortValue = DIO_u8_PORTC_REG ; break ;
			case DIO_u8_PORTD : *Copy_Pu8ReturnedPortValue = DIO_u8_PORTD_REG ; break ;
			default : Local_u8ErrorState = STD_TYPES_NOK ; break ;
		}
	}
	else
